...
- 흐름(**2026-08-21 전면 재배치**): **[C-PRJ-01] 시작 → [C-PRJ-02] 종합 결과 화면 → [C-PRJ-03] DAQ 장비 목록 → [C-PRJ-03-01] 탐촉자 모니터링**. 교정 = **[C-PRJ-04] 교정-사이드바 / [C-PRJ-04] 교정-파형 영역** 2문서 · **모달 아님 · 우측 436px 사이드바** + **탭 없이 ①~⑤ 세로 나열**(탐촉자 선택 → ①Pulser Control → ②영점 → ③음속 → ④경사각 → ⑤감도) · Gate는 파형 영역 드래그+hover 툴팁 · **구 Gain 설정·TCG 설정 모달은 교정으로 병합·폐기**.

...
- 설정(메뉴바 '설정' · 좌 트리/nav): **[C-SET-01]** DAQ 장비 설정(트리 구조(공통) + DAQ/탐촉자/홀더/홀더-장착 탐촉자/I/O 장비/Bridge PC = 7문서) · **[C-SET-02]** 모재 관리 · **[C-SET-03]** 모재 프리셋 관리 · **[C-SET-04]** 검사 시작 준비(맵핑) · **[C-SET-05]** 기본 설정 · **[C-SET-05]** 모니터링 서버 설정(같은 화면·좌 nav 2항목 → **문서 2개·ID 공유** · SET 번호는 01~05, 06 없음).

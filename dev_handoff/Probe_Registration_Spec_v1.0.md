...
프로브 주파수·진동자 크기·경사 각도, 검사체 재질·PRF·DAC 선도는 **교정 시 함께 설정**한다.
...
| **프로브 주파수 (MHz)** | number (0.5–20, step 0.25) | ✔ | 신규. 기존 '탐촉자 종류' 프리셋 분해 |

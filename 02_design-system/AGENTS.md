# AGENTS.md — 디자인 시스템 (ERUT)

ERUT의 **디자인 SSOT**. 모든 기획·UI·mockup의 시각 규칙·토큰·컴포넌트 단일 출처. 루트 지침(`../AGENTS.md`)의 디자인 관련 내용을 이 폴더로 분리한 문서.
...
> **용어 규칙(probe='탐촉자' 등)·NDT 도메인·화면 흐름은 루트 `../AGENTS.md` 및 `../01_materials/AGENTS.md` 참조.**
